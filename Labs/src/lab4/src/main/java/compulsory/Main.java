...
public class Main {
    public static void main(String[] args) {
        ...
        Student s6 = new Student("Xam", Stream.of(new Project("give"), new Project("never"), new Project("gonna")).collect(Collectors.toSet()));
        ...
        List<Student> students = new LinkedList<>(Arrays.asList(s6, s1, s2));
        ...
        Set<Project> projects = Stream.of(s6, s1, s2)
